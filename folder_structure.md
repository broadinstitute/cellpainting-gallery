...
Because barcoding and Cell Painting images can be acquired at different magnifications, the cycle folders start with the magnification at acquisiton (e.g. `10X_` or `20X_`).
...
If multiple rounds of Cell Painting occured and there was a duplication of a painting channel between rounds, append `_Round<n>` to the end of the illum name (e.g. `BR00117035_IllumDNA_Round1`).
