...
| Dataset name | Description | Publication to cite | Associated repositories | Size | Cell Painting protocol | IDR accession number |
|---|---|---|---|---|---|---|
...
| cpg0004-lincs | 1,571 compounds across 6 doses in A549 cells | 4 | [data](https://github.com/broadinstitute/lincs-cell-painting) | 65.7 TB | v2 | idr0125 |
...
| cpg0012-wawer-bioactivecompoundprofiling | 30,000 compound dataset in U2OS cells | 1,2 |  | 10.7 TB | v1 | idr0016 |
